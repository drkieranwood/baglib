function [ output_args ] = bag_load_nedptam( input_args ,  plot_on )
%ROS_LOAD_NEDPTAM Loads the NED transformed PTAM data output by ROSbag files.
...
if ~isempty(temp)
    ...
    warning('ROSLIB:LOAD_NEDPTAM','Input file is empty');
    output_args = [];
end

end %ros_load_nedptam
