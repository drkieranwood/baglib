function [ output_args ] = bag_load_nedvicon( input_args ,  plot_on )
%ROS_LOAD_NEDPTAM Loads the NED transformed Vicon data output by ROSbag files.
...
if ~isempty(temp)
    ...
    if plot_on
        ...
        h2 = figure('name','Vicon: Time: Rot'); hold on;
        temp_time = ( output_args.time - output_args.time(1) )/1000000000;
    ...
    warning('ROSLIB:LOAD_NEDVICON','Input file is empty');
    output_args = [];
end

end %ros_load_nedvicon
